...
class com_serial :
    ...
    def __init__(self,dir_com = '', time_input = '', inter_name = 0, public_name = 'COM_ARDUINO0', flag = False ):
        ...
        self.__dict_com = {0 :"RA0" , # 0-59 for request Analog Read or Digital Read pin m
                        ...
                        65:"F+16" ,
                        66:"F+32" ,
                        67:"F+64" ,   # Vuelta 1/64 sentido horario
                        68:"F+128" ,  # Vuelta 1/32 sentido horario
                        69:"F+256" ,  # Vuelta 1/16 sentido horario
                        70:"F+512" ,  # Vuelta 1/8 sentido horario
                        71:"F+1024" , # Vuelta 1/4 sentido horario
                        72:"F+2048" , # Vuelta 1/2 sentido horario
                        73:"F+4096" , # Vuelta completa sentido horario
    ...
    # Metodos
    def init_com(self,canal=0):
        """Metodo de Iniciar Comunicacion"""
        try:
            arduino_channel = serial.Serial(self.__dirCom,baudrate=9600,timeout=1.0) # Se crea y abre el canal de comunicacion
